                ...
                <div class="form-group">
                    <select id="From" class="custom-select" @change="changeCurrency()">
                        <option
                            ...
                            :key="index">{{ item.CurrencyCnName }}</option>
                    </select>
                    <button
                        id="changebtn"
                        class="btn btn-outline-success offset-5"
                        @click="changeSelect()">↑↓</button>
...
<script>
    ...
    export default {
        ...
        created() {
            axios
                .get('/vueproject/static/currencies.json') //.get('/vueproject/static/currencies.json')
