        ...
        <div class="col-md-10 offset-md-1">
            ...
            <div class="form-group">
                <div class="row border form-inline">
                    ...
                    <input type="text" v-model="currency" class="form-control col-sm-8 ml-2" placeholder="" maxlength="19">
                </div>
...
export default {
  ...
  computed:{
    ...
    const seconds = ['', 'Ten', 'Twenty', 'Thrity', 'Fourty', 'Fifty', 'Sixty', 'Seventy', 'Eighty', 'Ninety'];
    ...
    changeToTC () {
      ...
      if (num == "" || !num) return ""
      num = (~num.indexOf(',')) ? num.replace(/,/g, '') : +num;
      let digits = ['','壹', '貳', '參', '肆', '伍', '陸', '柒', '捌', '玖'];
      let tenDigits = ['', '拾', '貳拾', '參拾', '肆拾', '伍拾', '陸拾', '柒拾', '捌拾','玖拾'];
      let units = ['', '萬', '億', '兆', '京'];
